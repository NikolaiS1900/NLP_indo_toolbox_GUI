...
class App:
    ...
    def __init__(self, root):
        ...
        self.browse_button.grid(row=0, column=0, padx=10, pady=5, sticky="w")

        # Create input for file path
        self.file_entry = tk.Entry(root, textvariable=self.file_path, width=44, state="readonly")
        self.file_entry.grid(row=1, column=0, padx=10, pady=5, sticky="w")
        ...
        self.language_dropdown.grid(row=9, column=0, padx=10, pady=5, sticky="w")
        ...
        self.search_type.grid(row=8, column=0, padx=10, pady=5, sticky="w")
        ...
        self.find_words_in_text_button.grid(row=10, column=0, padx=10, pady=5, sticky="w")
